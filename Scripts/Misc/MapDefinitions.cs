...
namespace Server.Misc
{
	public class MapDefinitions
	{
		public static void Configure()
		{
			...
			RegisterMap( 0, 0, 0, 6144, 4096, 2, "Felucca",  MapRules.FeluccaRules ); // 0 = spring, 1 = summer, 2 = fall 3 = ?
			...
			*/
            ...
            MultiComponentList.PostHSFormat = false; // OSI Client Patch 7.0.9.0, set to False if client is below this
		}
